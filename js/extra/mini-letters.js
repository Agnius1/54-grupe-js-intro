...
// Nelogiskos reiksmes
{
  ...
  console.assert(
    ...
    "Yra tik vienas parametras (truksta 1)"
  );
  console.assert(
    isrinktiRaides(1, 2, 3) === "Netinkamas parametrų kiekis.",
    "Per daug parametru (3)"
  );
  console.assert(
    isrinktiRaides(1, 2, 3, 4) === "Netinkamas parametrų kiekis.",
    "Per daug parametru (4)"
  );
}
...
// Netinkami duomenu tipas - pirmasis parametras
{
  ...
  console.assert(
    isrinktiRaides(isrinktiRaides, 2) ===
...
// Netinkami duomenu tipas - antrasis parametras
{
  ...
  console.assert(
    isrinktiRaides("text", isrinktiRaides) ===
      "Antrasis kintamasis yra netinkamo tipo.",
...
// Nelogiskos reiksmes
{
  console.assert(
    isrinktiRaides("", 2) ===
      "Primasis kintamasis turi būti ne tuščias tekstas.",
    "Tuščias tekstas"
  );
  console.assert(
    isrinktiRaides("abc", 0) ===
      "Antrasis kintamasis negali būti lygus nuliui.",
    "Step: 0"
  );
  console.assert(
  ...
  console.assert(
    isrinktiRaides("abc", Infinity) ===
      "Antrasis kintamasis turi būti sveikasis skaičius.",
    "Begalinis zingsnis (+)"
  );
  console.assert(
    isrinktiRaides("abc", -Infinity) ===
